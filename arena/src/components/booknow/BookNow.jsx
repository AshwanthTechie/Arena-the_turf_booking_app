...
const BookNow = () => {
  ...
  const handleSubmit = (event) => {
    ...
    if (formData.fromTime && formData.toTime && formData.toTime.isAfter(formData.fromTime)) {
      ...
      const options = {
        key: "rzp_test_xtFnbnQ0oQ9B1o", // your key here
        secretkey: "6hJKdPHxGCkjBLvHGzdWjsMK", // your secret key
        amount: totalPrice * 100, // Amount in paise
        currency: "INR",
        name: "Arena",
        description: "Booking Payment",
        method: {
          upi: true // Enable UPI as a payment method
        },
        ...
        // Adding payment method preferences
        payment_method: {
          upi: {
            vpa: true // This enables the UPI Virtual Payment Address option
          }
        }
      };
